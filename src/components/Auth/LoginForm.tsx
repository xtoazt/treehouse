      ...
      >
        <div className="text-center">
          <motion.div
            ...
            className="mx-auto h-16 w-16 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl flex items-center justify-center"
          >
          ...
          <motion.h2
            ...
            className="mt-6 text-3xl font-display font-bold text-gray-900"
          >
            Welcome back
          </motion.h2>
          <motion.p
